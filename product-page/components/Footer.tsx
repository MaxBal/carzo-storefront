      ...
      <div className="hidden md:block">
        <div className="mx-auto max-w-[1280px] px-4 py-12 lg:px-8">
          <div className="grid grid-cols-5 gap-8">
            {/* Column 1: Каталог */}
            <div>
              <h3 className="mb-4 text-[18px] font-medium text-white">Каталог</h3>
            ...
            {/* Column 2: Покупцеві */}
            <div>
              <h3 className="mb-4 text-[18px] font-medium text-white">Покупцеві</h3>
              <ul className="space-y-3">
            ...
            {/* Column 3: B2B */}
            <div>
              <h3 className="mb-4 text-[18px] font-medium text-white">B2B</h3>
              <ul className="space-y-3">
                {b2bLinks.map(link => (
                  <li key={link.label}>
                    <a
            ...
            <div>
              <h3 className="mb-4 text-[18px] font-medium text-white">Carzo Bonus</h3>
              <ul className="space-y-3">
                {bonusLinks.map(link => (
                  <li key={link.label}>
                    <a
            ...
            {/* Column 5: Контакти */}
            <div>
              <h3 className="mb-4 text-[18px] font-medium text-white">Зателефонувати</h3>
              ...
              <h3 className="mb-3 mt-6 text-[18px] font-medium text-white">Приєднатися</h3>
